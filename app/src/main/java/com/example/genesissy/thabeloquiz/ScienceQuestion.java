...
public class ScienceQuestion extends Activity {
    ...
    public void Results(View v){
        ...
        Intent GetResults=new Intent(this,ScienceResults.class);
        //this display for score A
        final TextView ResultsA= (TextView)findViewById(R.id.Timer);
        scoremassegeA = ResultsA.getText().toString();
        GetResults.putExtra("ScoreA",scoremassegeA);
    ...
    void timmer(){
        countDownTimer = new CountDownTimer(180000, 1000){
            ...
            public void onFinish() {
                Intent i = new Intent(ScienceQuestion.this,Gameover.class);
                startActivity(i);
                Toast.makeText(ScienceQuestion.this, "GAME OVER",Toast.LENGTH_LONG).show();
            }
        }.start();
    }
